...
export default function AboutMe() {
  ...
  return (
    ...
    >
      <div className="mt-20">
        <div>
          <i className="bi bi-quote text-7xl text-[#a1f452]"></i>
        </div>
        <div>
          <span className="text-2xl rethink-sans">
            I'm a{" "}
            <span>
              <Devs />
            </span>{" "}
            ...
            project types. In my tech journey, I've tackled diverse technical
            challenges—developing custom solutions that strike a seamless
            balance between <span className="font-bold">functionality</span>,
            performance, and aesthetics. I take{" "}
            <span className="font-bold">pride</span> in solving technical
            ...
            <span className="font-bold">business goals.</span> I'm passionate
            about staying at the forefront of frontend technologies and
            continuously exploring new ways to elevate user engagement through
            smart, scalable, and{" "}
